      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
            ...
            >
              <h2 className="text-2xl font-black text-green-900 mb-6 text-center font-noto-serif">
                遊び方
              </h2>
              ...
              <p className="mt-6 text-center text-green-900 text-lg font-black bg-amber-200 rounded-2xl py-3 px-4 font-noto-serif">
                10貫中1つにワサビ入りが隠れています
              </p>

              <button
                onClick={onClose}
                className="mt-8 w-full bg-green-800 text-white font-bold py-3 rounded-2xl font-noto-serif"
              >
                とじる
              </button>
            </motion.div>
